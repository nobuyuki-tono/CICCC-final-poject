...
const Navbar = () => {
  ...
  window.onscroll = () => {
    ...
    window.pageYOffset > 148
      ? menu.classList.add("menu_fixed", "animate")
      : menu.classList.remove("menu_fixed", "animate");
  };
          ...
          <div className="row align_items">
            <div className="col-lg-2">
              <nav className="navbar navbar-expand-lg">
                ...
                <div
                  ref={navMenu}
                  className="navbar-collapse main-menu-item justify-content-center collapse"
                >
